Это версия страницы http://www.biolansys.com/Arduino/TinyBasicPlus_PP.ino из кеша Google. Она представляет собой снимок страницы по состоянию на 22 июл 2016 21:32:46 GMT.
...
static const unsigned char helpmsg[]          PROGMEM = " Commands: HELP LIST MEM ESAVE ELOAD EFORMAT DBLINK";
#ifdef ARDUINO
#ifdef ENABLE_EEPROM

...
LiquidCrystal lcd(3, 5, 9, 10, 11, 12);			// initialize the library with the numbers of the interface pins
#include <Servo.h> 
...
servo:
	{
		...
		if (value == 255) {
			...
			pinDir[whichPin] = 0;						//Clear flag
		
		}
		else {
			myservo[pinDef[whichPin]].write(value);
		}

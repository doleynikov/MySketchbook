...
// v0.16 XMEM of ATMega2560 supporing (single bank)...
...
#include "xmem.h"
#include<stdio.h>
#include <avr/malloc.h>
//char screenMem[168]; //the implementation of frame buffer is referenced from Ben Heck's
char *screenMem=reinterpret_cast<char *>(0xFF00); //the implementation of frame buffer is referenced from Ben Heck's
...
//#define kRamSize  5000 
//#define kRamSize 5150
//// Memory size is defined by "xmemsize" below....
#ifndef ARDUINO
// Not arduino setup
#include <stdio.h>
#include <stdlib.h>
...
static unsigned char *program=reinterpret_cast<unsigned char *>(0x2700);
...
//static unsigned char *stack=reinterpret_cast<unsigned char *>(0x2200); 
// Software stack for things that should go on the CPU stack
///static unsigned char *stack; // Software stack for things 
///that should go on the CPU stack
...
void loop()
{
  ...
  program_end = program_start;
    sp1 = program+xmemsize;  // Needed for printnum  
//    sp1 = program+sizeof(program);  // Needed for printnum
//  stack_limit = program+sizeof(program)-STACK_SIZE;
//      sp1 = program+20000;  // Needed for printnum
  stack_limit = program+xmemsize-STACK_SIZE;
...
forloop:
  {
    ...
    if(!expression_error && *txtpos == NL)
    {
      ...
      ((int *)variables_begin)[var-'A'] = initial;
...
////// xmem extension //////
  xmem::begin(true);
  xmem::setMemoryBank(0,true);
  //static unsigned char *program=reinterpret_cast<unsigned char *>(0x2201);
//  program=(unsigned char *)malloc(50000);
//  char *program=reinterpret_cast<char *>(0x3200);
//  malloc(50000);
